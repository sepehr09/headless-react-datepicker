...
}`,...(S=(k=h.parameters)==null?void 0:k.docs)==null?void 0:S.source},description:{story:`Frosted glassmorphism on a soft aurora gradient. The range fill is a
translucent white; the selected ends are a violet→pink gradient pill.`,...(z=(v=h.parameters)==null?void 0:v.docs)==null?void 0:z.description}}};var T,A,R,F,E;p.parameters={...p.parameters,docs:{...(T=p.parameters)==null?void 0:T.docs,source:{originalSource:`{
  args: {
    ...singleArgs,
...
}`,...(R=(A=p.parameters)==null?void 0:A.docs)==null?void 0:R.source},description:{story:"A dark dashboard look: near-black card, cyan neon selection with a glow, a\nhot-pink weekend accent, and a matching `TimePicker`.",...(E=(F=p.parameters)==null?void 0:F.docs)==null?void 0:E.description}}};var C,D,O,B,N;m.parameters={...m.parameters,docs:{...(C=m.parameters)==null?void 0:C.docs,source:{originalSource:`{
  args: rangeArgs,
  render: ThemedCalendar({
    page: {
...
for the selected ends and a soft peach fill in between.`,...(N=(B=m.parameters)==null?void 0:B.docs)==null?void 0:N.description}}};var j,L,M,P,U;i.parameters={...i.parameters,docs:{...(j=i.parameters)==null?void 0:j.docs,source:{originalSource:`{
  args: singleArgs,
  render: ThemedCalendar({
    page: {
      background: "#fafafa"
...
spreadsheet-like take on the range picker.`,...(ee=($=c.parameters)==null?void 0:$.docs)==null?void 0:ee.description}}};var de,re,ae,te,ne;f.parameters={...f.parameters,docs:{...(de=f.parameters)==null?void 0:de.docs,source:{originalSource:`{
  args: rangeArgs,
  render: ThemedCalendar({
    page: {
      background: "#f4f4f5"
...
editorial counterpart to Crimson Grid's bold, tight grid.`,...(ne=(te=f.parameters)==null?void 0:te.docs)==null?void 0:ne.description}}};var he,pe,me,ie,se;g.parameters={...g.parameters,docs:{...(he=g.parameters)==null?void 0:he.docs,source:{originalSource:`{
  args: singleArgs,
  render: ThemedCalendar({
    page: {
      background: "#f2f2f7"
...
}`,...(me=(pe=g.parameters)==null?void 0:pe.docs)==null?void 0:me.source},description:{story:`The native iOS Calendar look: a crisp white sheet on a light-grey backdrop,
...
}`,...(xe=(be=y.parameters)==null?void 0:be.docs)==null?void 0:xe.source},description:{story:"A space-saving, dense layout — ideal for tight popovers or sidebars. Nothing\nbut tokens shrink it: smaller day cells (`--rhmdp-day-padding` /\n`--rhmdp-day-height`), smaller type and a tighter radius, on a narrow card.\nUses the in-grid `PanelHeader` so the month/year pickers don't add a separate\nrow — keeping the footprint minimal.",...(ue=(we=y.parameters)==null?void 0:we.docs)==null?void 0:ue.description}}};const je=["AuroraGlass","MidnightNeon","SunsetPeach","MinimalMono","MintFresh","RoyalGold","CrimsonGrid","LimeSheet","IOSCupertino","AndroidMaterialYou","Compact"];export{l as AndroidMaterialYou,h as AuroraGlass,y as Compact,c as CrimsonGrid,g as IOSCupertino,f as LimeSheet,p as MidnightNeon,i as MinimalMono,s as MintFresh,o as RoyalGold,m as SunsetPeach,je as __namedExportsOrder,Ne as default};
