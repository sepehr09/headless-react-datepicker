...
}`,...(v=(S=p.parameters)==null?void 0:S.docs)==null?void 0:v.source},description:{story:`Frosted glassmorphism on a soft aurora gradient. The range fill is a
translucent white; the selected ends are a violet→pink gradient pill.`,...(T=(z=p.parameters)==null?void 0:z.docs)==null?void 0:T.description}}};var A,R,F,E,C;n.parameters={...n.parameters,docs:{...(A=n.parameters)==null?void 0:A.docs,source:{originalSource:`{
  args: {
    ...singleArgs,
    initialValue: createLocalDate(2024, 5, 16, 21, 30)
  },
  render: ThemedCalendar({
    page: {
...
}`,...(F=(R=n.parameters)==null?void 0:R.docs)==null?void 0:F.source},description:{story:"A dark dashboard look: near-black card, cyan neon selection with a glow, a\nhot-pink weekend accent, and a matching `TimePicker`.",...(C=(E=n.parameters)==null?void 0:E.docs)==null?void 0:C.description}}};var D,O,L,j,B;m.parameters={...m.parameters,docs:{...(D=m.parameters)==null?void 0:D.docs,source:{originalSource:`{
  args: rangeArgs,
  render: ThemedCalendar({
    page: {
...
}`,...(L=(O=m.parameters)==null?void 0:O.docs)==null?void 0:L.source},description:{story:`Warm and friendly: a cream card on a peachy gradient, an orange→pink gradient
for the selected ends and a soft peach fill in between.`,...(B=(j=m.parameters)==null?void 0:j.docs)==null?void 0:B.description}}};var N,M,P,U,_;i.parameters={...i.parameters,docs:{...(N=i.parameters)==null?void 0:N.docs,source:{originalSource:`{
  args: singleArgs,
  render: ThemedCalendar({
    page: {
      background: "#fafafa"
...
}`,...(P=(M=i.parameters)==null?void 0:M.docs)==null?void 0:P.source},description:{story:`Editorial and quiet: lots of whitespace, thin type, a single black dot for
the selected day.`,...(_=(U=i.parameters)==null?void 0:U.docs)==null?void 0:_.description}}};var K,G,H,W,V;s.parameters={...s.parameters,docs:{...(K=s.parameters)==null?void 0:K.docs,source:{originalSource:`{
  args: rangeArgs,
  render: ThemedCalendar({
    page: {
...
}`,...(H=(G=s.parameters)==null?void 0:G.docs)==null?void 0:H.source},description:{story:`Soft, calm pastels — a mint/teal palette with rounded pills and a gentle mint
fill for the selected range.`,...(V=(W=s.parameters)==null?void 0:W.docs)==null?void 0:V.description}}};var I,Y,q,J,Q;o.parameters={...o.parameters,docs:{...(I=o.parameters)==null?void 0:I.docs,source:{originalSource:`{
  args: singleArgs,
  render: ThemedCalendar({
    page: {
...
}`,...(q=(Y=o.parameters)==null?void 0:Y.docs)==null?void 0:q.source},description:{story:`Luxe and dramatic: deep indigo card with a warm gold gradient accent for the
selected day.`,...(Q=(J=o.parameters)==null?void 0:J.docs)==null?void 0:Q.description}}};var X,Z,$,ee,de;c.parameters={...c.parameters,docs:{...(X=c.parameters)==null?void 0:X.docs,source:{originalSource:`{
  args: rangeArgs,
  render: ThemedCalendar({
    page: {
      background: "#f4f4f5"
...
}`,...($=(Z=c.parameters)==null?void 0:Z.docs)==null?void 0:$.source},description:{story:`A bordered, square-celled grid with a bold crimson selection — a structured,
spreadsheet-like take on the range picker.`,...(de=(ee=c.parameters)==null?void 0:ee.docs)==null?void 0:de.description}}};var re,ae,te,he,pe;f.parameters={...f.parameters,docs:{...(re=f.parameters)==null?void 0:re.docs,source:{originalSource:`{
  args: rangeArgs,
  render: ThemedCalendar({
    page: {
      background: "#f4f4f5"
...
}`,...(te=(ae=f.parameters)==null?void 0:ae.docs)==null?void 0:te.source},description:{story:`Grid-lined and airy: hairline shared borders, a wide-tracked thin uppercase
title set in an inset header bar, and a punchy lime selection. The light,
editorial counterpart to Crimson Grid's bold, tight grid.`,...(pe=(he=f.parameters)==null?void 0:he.docs)==null?void 0:pe.description}}};var ne,me,ie,se,oe;g.parameters={...g.parameters,docs:{...(ne=g.parameters)==null?void 0:ne.docs,source:{originalSource:`{
  args: singleArgs,
  render: ThemedCalendar({
    page: {
      background: "#f2f2f7"
...
}`,...(ie=(me=g.parameters)==null?void 0:me.docs)==null?void 0:ie.source},description:{story:`The native iOS Calendar look: a crisp white sheet on a light-grey backdrop,
the system red accent for today and the selected day, and fully-rounded day
circles.`,...(oe=(se=g.parameters)==null?void 0:se.docs)==null?void 0:oe.description}}};var ce,fe,ge,le,ye;l.parameters={...l.parameters,docs:{...(ce=l.parameters)==null?void 0:ce.docs,source:{originalSource:`{
  args: rangeArgs,
  render: ThemedCalendar({
    page: {
      background: "#e7e0ec"
...
}`,...(ge=(fe=l.parameters)==null?void 0:fe.docs)==null?void 0:ge.source},description:{story:'Material 3 / "Material You": a soft purple-tinted surface, the signature\n`#6750A4` primary for the selected ends, a light primary-container fill for\nthe in-range days and generously rounded corners.',...(ye=(le=l.parameters)==null?void 0:le.docs)==null?void 0:ye.description}}};var be,xe,we,ue,ke;y.parameters={...y.parameters,docs:{...(be=y.parameters)==null?void 0:be.docs,source:{originalSource:`{
  args: singleArgs,
  render: ThemedCalendar({
    panelHeader: true,
    page: {
...
}`,...(we=(xe=y.parameters)==null?void 0:xe.docs)==null?void 0:we.source},description:{story:"A space-saving, dense layout — ideal for tight popovers or sidebars. Nothing\nbut tokens shrink it: smaller day cells (`--rhmdp-day-padding` /\n`--rhmdp-day-height`), smaller type and a tighter radius, on a narrow card.\nUses the in-grid `PanelHeader` so the month/year pickers don't add a separate\nrow — keeping the footprint minimal.",...(ke=(ue=y.parameters)==null?void 0:ue.docs)==null?void 0:ke.description}}};const Me=["AuroraGlass","MidnightNeon","SunsetPeach","MinimalMono","MintFresh","RoyalGold","CrimsonGrid","LimeSheet","IOSCupertino","AndroidMaterialYou","Compact"];export{l as AndroidMaterialYou,p as AuroraGlass,y as Compact,c as CrimsonGrid,g as IOSCupertino,f as LimeSheet,n as MidnightNeon,i as MinimalMono,s as MintFresh,o as RoyalGold,m as SunsetPeach,Me as __namedExportsOrder,Ne as default};
