...
}`,...(v=(j=t.parameters)==null?void 0:j.docs)==null?void 0:v.source},description:{story:"A fully custom UI via the `renderer` prop — the consumer renders its own\ncomponent (here, editable number inputs) and the library only supplies the\ntime parts and setters.",...(T=(P=t.parameters)==null?void 0:P.docs)==null?void 0:T.description}}};const B=["HoursAndMinutes","TwelveHour","WithSeconds","CustomRenderer"];export{t as CustomRenderer,n as HoursAndMinutes,s as TwelveHour,a as WithSeconds,B as __namedExportsOrder,q as default};
