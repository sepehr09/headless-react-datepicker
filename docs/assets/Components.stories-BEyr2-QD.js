import{j as e}from"./jsx-runtime-BjG_zV1W.js";import{D as a,e as Ye,c as Ce,H as Fe,d as Ie,j as Ue,b as _e,a as Ve,P as v,f as Ee,i as qe,W as Re,h as ze,k as Ge,g as Je,l as Ke,T as Qe}from"./dates-Brrr1cyH.js";import{b as Xe}from"./constants-COfiGr61.js";import{a as n}from"./_source-CMrf7hAM.js";import"./iframe-CfoPbdHn.js";import"./preload-helper-C1FmrZbK.js";const sr={title:"Example/Components",...Xe,parameters:{docs:{description:{component:`The library is **headless** and built from small, independent pieces. Every
...
\`Calendar\` section) to build a full date picker.`}}}},s={isRange:!1,initialValue:Ce(2025,4,17),calendar:"gregory",config:{locale:"en-US",weekStartsOn:"monday",showOtherDays:!1,otherDaysSelectable:!1,weekdayFormat:"short",dayFormat:"numeric",weekends:["saturday","sunday"],weekendSelectable:!0}},t={name:"Title",parameters:n(["Title"],"<Title />"),render:r=>e.jsx(a,{...r,children:e.jsx(Qe,{})}),args:s},o={name:"Header",parameters:n(["Header"],"<Header />"),render:r=>e.jsx(a,{...r,children:e.jsx(Ue,{})}),args:s},d={name:"HeaderPrevButton",parameters:n(["HeaderPrevButton"],"<HeaderPrevButton />"),render:r=>e.jsx(a,{...r,children:e.jsx(_e,{})}),args:s},i={name:"HeaderNextButton",parameters:n(["HeaderNextButton"],"<HeaderNextButton />"),render:r=>e.jsx(a,{...r,children:e.jsx(Ie,{})}),args:s},c={name:"HeaderMonthSelect",parameters:n(["HeaderMonthSelect"],"<HeaderMonthSelect />"),render:r=>e.jsx(a,{...r,children:e.jsx(Fe,{})}),args:s},l={name:"HeaderYearSelect",parameters:n(["HeaderYearSelect"],"<HeaderYearSelect />"),render:r=>e.jsx(a,{...r,children:e.jsx(Ve,{})}),args:s},P={name:"Panel Header",parameters:n(["PanelHeader"],"<PanelHeader />"),render:r=>e.jsx(a,{...r,children:e.jsx(Ge,{})}),args:s},m={name:"PanelHeaderLabel",parameters:n(["PanelHeaderProvider","PanelHeaderLabel"],`<PanelHeaderProvider>
  <PanelHeaderLabel />
...
</PanelHeaderProvider>`),render:r=>e.jsx(a,{...r,children:e.jsx(v,{children:e.jsx(Je,{})})}),args:s},H={name:"PanelHeaderNextButton",parameters:n(["PanelHeaderProvider","PanelHeaderNextButton"],`<PanelHeaderProvider>
  <PanelHeaderNextButton />
</PanelHeaderProvider>`),render:r=>e.jsx(a,{...r,children:e.jsx(v,{children:e.jsx(ze,{})})}),args:s},u={name:"PanelHeaderBody",parameters:n(["PanelHeaderProvider","PanelHeaderLabel","PanelHeaderBody","WeekDays","DaySlots"],`<PanelHeaderProvider>
  <PanelHeaderLabel />
  <PanelHeaderBody>
    <WeekDays />
    <DaySlots />
  </PanelHeaderBody>
</PanelHeaderProvider>`),render:r=>e.jsx(a,{...r,children:e.jsxs(v,{children:[e.jsx(Ee,{}),e.jsxs(qe,{children:[e.jsx(Re,{}),e.jsx(Ye,{})]})]})}),args:s},y={name:"WeekDays",parameters:n(["WeekDays"],"<WeekDays />"),render:r=>e.jsx(a,{...r,children:e.jsx(Re,{})}),args:s},h={name:"DaySlots",parameters:n(["DaySlots"],"<DaySlots />"),render:r=>e.jsx(a,{...r,children:e.jsx(Ye,{})}),args:s},g={name:"TimePicker",parameters:n(["TimePicker"],"<TimePicker showSeconds use12Hours />"),render:r=>e.jsx(a,{...r,children:e.jsx(Ke,{showSeconds:!0,use12Hours:!0})}),args:s};var k,S,x,D,B;t.parameters={...t.parameters,docs:{...(k=t.parameters)==null?void 0:k.docs,source:{originalSource:`{
  name: "Title",
  ...
  args: baseArgs
}`,...(Ae=(We=g.parameters)==null?void 0:We.docs)==null?void 0:Ae.source},description:{story:"`TimePicker` edits the time portion (hours/minutes, optional seconds and an\nAM/PM toggle) of the currently selected day. Here it's shown standalone with\nseconds and a 12-hour clock enabled.",...(Me=(Le=g.parameters)==null?void 0:Le.docs)==null?void 0:Me.description}}};const tr=["TitleOnly","HeaderOnly","HeaderPrevButtonOnly","HeaderNextButtonOnly","HeaderMonthSelectOnly","HeaderYearSelectOnly","PanelHeaderOnly","PanelHeaderLabelOnly","PanelHeaderPrevButtonOnly","PanelHeaderNextButtonOnly","PanelHeaderBodyOnly","WeekDaysOnly","DaySlotsOnly","TimePickerOnly"];export{h as DaySlotsOnly,c as HeaderMonthSelectOnly,i as HeaderNextButtonOnly,o as HeaderOnly,d as HeaderPrevButtonOnly,l as HeaderYearSelectOnly,u as PanelHeaderBodyOnly,m as PanelHeaderLabelOnly,H as PanelHeaderNextButtonOnly,P as PanelHeaderOnly,p as PanelHeaderPrevButtonOnly,g as TimePickerOnly,t as TitleOnly,y as WeekDaysOnly,tr as __namedExportsOrder,sr as default};
