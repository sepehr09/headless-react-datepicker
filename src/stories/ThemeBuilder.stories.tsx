...
const PRESETS: Preset[] = [
  ...
  },
  {
    ...
    tokens: {
      ...
      "--rhmdp-day-hover-text": "#303030",
      "--rhmdp-day-today-text": "#303030",
      "--rhmdp-day-disabled-text": "#c0c4ca",
      "--rhmdp-arrow-hover-bg": "#ececef",
      "--rhmdp-arrow-hover-text": "#303030",
      ...
      "--rhmdp-time-text": "#303030",
      "--rhmdp-panel-selected-bg": "#303030",
      "--rhmdp-panel-selected-text": "#ffffff",
      "--rhmdp-panel-cell-hover-bg": "#ececef",
      "--rhmdp-panel-cell-hover-text": "#303030",
    },
  },
  {
    name: "Crimson Grid",
  ...
  },
  {
    ...
    tokens: {
      ...
      "--rhmdp-day-hover-text": "#ffffff",
      "--rhmdp-day-today-text": "#ff4794",
      "--rhmdp-day-weekend-text": "#ff4794",
      "--rhmdp-day-holiday-text": "#ff79b0",
      "--rhmdp-day-disabled-text": "#6b6b6b",
      "--rhmdp-weekday-text": "#7a7a7a",
      "--rhmdp-title-text": "#ffffff",
      "--rhmdp-arrow-text": "#ffffff",
      "--rhmdp-arrow-hover-bg": "#4a4a4a",
      "--rhmdp-arrow-hover-text": "#ffffff",
      ...
      "--rhmdp-header-select-padding": "4px",
      "--rhmdp-time-text": "#ffffff",
      "--rhmdp-panel-selected-bg": "#ff4794",
      "--rhmdp-panel-selected-text": "#ffffff",
      "--rhmdp-panel-cell-text": "#ffffff",
      "--rhmdp-panel-cell-hover-bg": "#4a4a4a",
      "--rhmdp-panel-cell-hover-text": "#ffffff",
    },
    preview: {
